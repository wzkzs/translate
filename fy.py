...
class Dict:
    def __init__(self):
        ...
        # 创建一个事件容器，并注册 selection_recevied 事件函数
...
<style>
.add_to_wordbook {
    background: url(https://doc.shiyanlou.com/md0417215add.png) no-repeat;
